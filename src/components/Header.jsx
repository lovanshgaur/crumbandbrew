  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-[var(--bg-base)]/80 border-b border-[var(--border)]">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <button className="w-10 h-10 flex items-center justify-center rounded-full border border-[var(--border)] bg-[var(--bg-surface)] hover:bg-[var(--border)] transition-all">
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
